...
export default function Home({ portfolioItem, VITOZAUTHOR }) {
  return (
    <div>
      <div>
        <Head>
          <title>{portfolioItem.seo.title}</title>
          <meta name="description" content={portfolioItem.seo.description} />
          <meta property="og:title" content={portfolioItem.seo.title} />
          <meta
            property="og:description"
            content={portfolioItem.seo.description}
          />
          <meta property="og:url" content={portfolioItem.seo.image.url} />
      ...
      <section className="pb-20">
          ...
          <div className="container">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex justify-center mb-8">
                ...
                />
                <div className="pl-4">
                  <p className="text-gray-500 mb-1">{VITOZAUTHOR.name}</p>
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto">
            <p
              className="mb-6 leading-loose text-gray-400 wow animate__animated animate__fadeIn animated"
              data-wow-delay=".1s"
            >
              <RichText content={portfolioItem.richText.raw.children} />
            </p>
          </div>
          ...
          <div
            ...
            style={{
              backgroundImage: "url(`${portfolioItem.coverImage.url}`)",
            }}
          >
            <div className="max-w-2xl mx-auto">
