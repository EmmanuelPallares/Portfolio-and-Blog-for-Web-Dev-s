...
const Blog = (blogs) => {
  const BLOGSPROPS = blogs.props.DATA.blogPosts;
  console.log(BLOGSPROPS);
  return (
    <>
      <div className="bg-gray-100 px-4 xl:px-0 py-12">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8">
              <div>
                <img
                  ...
                  alt="computer"
                />
                <div className="py-4 px-8 w-full flex justify-between bg-[#345443]">
                  ...
                  <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                    <div>
                      <img
                        ...
                        alt="games"
                      />
                      <div className="py-2 px-4 w-full flex justify-between bg-red-700">
                        <p className="text-sm text-white font-semibold tracking-wide">
                          Bruce Wayne
                        </p>
                        <p className="text-sm text-white font-semibold tracking-wide">
                ...
                <div className="mt-10 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                  <div>
                    <img
                      ...
                      alt="laptop"
                    />
                    <div className="py-2 px-4 w-full flex justify-between bg-blue-700">
                      <p className="text-sm text-white font-semibold tracking-wide">
                        Bruce Wayne
                      </p>
                      <p className="text-sm text-white font-semibold tracking-wide">
