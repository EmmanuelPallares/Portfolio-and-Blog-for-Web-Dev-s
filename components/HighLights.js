  ...
  return (
    <div className="flex-1 bg-[#111823]">
      <div className="flex-1 flex flex-col items-center">
        <h3 className="text-white mt-2 py-1.5 2xl:text-5xl md:text-5xl text-3xl  font-extrabold md:leading-[60px] leading-snug lg:leading-[60px] text-center biggestUIlibrary t-f-c bg-clip-text">
          TitleSub Component.js
        </h3>
        <p className="md:text-lg text-base leading-snug mt-[30px] text-center dark:text-gray-400 text-gray-600 md:w-[700px]">
