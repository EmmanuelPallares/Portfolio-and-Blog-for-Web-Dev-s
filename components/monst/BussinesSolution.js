...
const BussinesSolution = () => {
  return (
    <section className="pt-16 pb-20 " id="key-features">
      <div className="container bg-hero-pattern">
        <div className="flex flex-wrap items-center mb-12">
          <div className="w-full lg:w-1/2 mb-6 lg:mb-0">
            <h2
              className="text-4xl font-bold font-heading wow  animate__animated animate__flipInY shadow-2xl"
              data-wow-delay="0"
        ...
        <div className="flex flex-wrap -mx-3 -mb-6">
          <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
            <div
              className="border border-gray-100 pt-8 px-6 pb-6 bg-[#111823] text-center rounded shadow hover:shadow-lg hover-up-2 transition duration-500 wow animate__animated animate__shakeY"
              data-wow-delay=".8s"
            >
